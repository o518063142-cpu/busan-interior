  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setResult({
        ...
        summaryMessage: `한신인테리어는 부산진구 전포동·서면 실내건축 면허 업체로서 고객님의 ${formInput.spaceType} 공간을 가장 완성도 높게 구현해 드립니다.`,
      });
    } finally {
      setLoading(false);
    }
    ...
    <div className="max-w-7xl mx-auto px-4 lg:px-8 py-12 space-y-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 space-y-6">
          {!result && !loading && (
            <div className="bg-stone-900 text-white p-8 sm:p-12 rounded-3xl border border-stone-800 text-center space-y-4 shadow-xl">
          ...
          {result && !loading && (
            <div className="bg-stone-900 text-white p-6 sm:p-8 rounded-3xl border border-stone-800 shadow-2xl space-y-8 animate-in fade-in duration-300">
              {/* Result Header */}
              <div className="border-b border-stone-800 pb-4 flex items-center justify-between flex-wrap gap-2">
                <div>
                ...
                <div className="px-3 py-1 bg-amber-500/20 text-amber-300 border border-amber-500/30 rounded-lg text-xs font-bold">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-stone-300 bg-stone-950 p-4 rounded-2xl border border-stone-800">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 text-xs">
                  {result.constructionPhases.map((phase, idx) => (
                    <div
                      key={idx}
                      className="bg-stone-950 p-3.5 rounded-xl border border-stone-800 flex items-start justify-between gap-3"
                    >
                      <div>
                      ...
                      <span className="text-[11px] bg-stone-800 px-2 py-1 rounded text-stone-300 whitespace-nowrap font-semibold shrink-0">
              ...
              <div className="space-y-3">
                ...
                <ul className="space-y-1.5 text-xs text-stone-300 bg-stone-950 p-4 rounded-2xl border border-stone-800">
