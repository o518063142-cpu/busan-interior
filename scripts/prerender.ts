...
const STATIC_ROUTES: StaticRouteConfig[] = [
  ...
  },
  {
    ...
    description:
      "지니 인테리어(GENE INTERIOR) 대표 시공사례 포트폴리오. 부산 주거·상가·카페·사무실 리모델링 완공 및 비포/애프터 공사 과정 공개.",
    h1: "지니 인테리어 대표 시공사례 포트폴리오",
    summary:
      "부산진구 전포동, 서면, 동래구, 해운대구 등 부산 주요 지역의 아파트, 상가, 카페, 사무실 시공 완공 사례와 상세 공사 내역을 확인하실 수 있습니다.",
    schemaType: "page",
  },
  {
    path: "/information",
  ...
  },
  {
    ...
    summary:
      "건설산업기본법 기준을 준수하는 실내건축공사업 정식 등록업체로서, 무면허 무자격 시공의 위험으로부터 고객을 보호하고 100% 투명하고 안전한 시공 품질을 보증합니다.",
    schemaType: "trust",
  },
  {
    path: "/contact",
    ...
    summary:
      "부산진구 전포동, 서면 및 부산 전 지역 현장 실측을 무료로 진행합니다. 실내건축 전문 기사가 직접 방문하여 공간 구조를 실측하고 상세 견적을 안내해 드립니다.",
    schemaType: "page",
  },
  {
    path: "/ai-estimate",
    ...
    summary:
      "공간 유형, 면적, 희망 스타일, 공사 범위를 입력하시면 부산 지역 최신 인테리어 시세를 분석하여 예상 공사 금액과 기간, 단계별 시공 팁을 안내합니다.",
    schemaType: "page",
  },
];
          ...
          ? `
            <section class="bg-white p-8 rounded-3xl border border-stone-200 shadow-sm space-y-4">
              ...
              <p class="text-stone-700 leading-relaxed text-sm">
                ...
                지니 인테리어가 직접 진행한 실제 시공사례와 공사 정보를 확인하실 수 있습니다.
              </p>
...
export async function runPrerender() {
  ...
  for (const route of STATIC_ROUTES) {
    const canonicalUrl = `${SITE_ENTITY.url}${
    ...
    // Inject OpenGraph + Twitter + JSON-LD
    const ogBlock = `
