    ...
    const homeSchema = {
      ...
      "@graph": [
        ...
        },
        {
          ...
          alternateName: SITE_CONFIG.brand.nameEn,
          description: route.description,
          publisher: {
            "@id": `${baseUrl}/#organization`,
          },
    ...
    extraContent = `
      <section class="bg-white p-8 rounded-3xl border border-stone-200 shadow-sm space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <article class="p-5 border border-stone-200 rounded-2xl">

            <h3 class="font-bold text-stone-900">

              <a href="/projects/busan-mangmi-jugong-apartment-remodeling">
                부산 망미주공 아파트 리모델링
              </a>
          ...
          <article class="p-5 border border-stone-200 rounded-2xl">
            ...
            <h3 class="font-bold text-stone-900">
              ...
              <a href="/projects/busan-sinpyeong-samchang-apartment-remodeling">
                부산 신평 삼창아파트 리모델링
              </a>
          ...
          <article class="p-5 border border-stone-200 rounded-2xl">
            ...
            <h3 class="font-bold text-stone-900">
              ...
              <a href="/projects/busan-sajik-villa-remodeling">
                부산 사직동 빌라 리모델링
              </a>
          ...
          <article class="p-5 border border-stone-200 rounded-2xl">
            ...
            <h3 class="font-bold text-stone-900">
              ...
              <a href="/projects/gyeongnam-elementary-school-vr-classroom-remodeling">
                경남 초등학교 VR교실 리모델링
              </a>
          ...
          <article class="p-5 border border-stone-200 rounded-2xl">
            ...
            <h3 class="font-bold text-stone-900">
              ...
              <a href="/projects/ulsan-elementary-school-classroom-interior">
                울산 초등학교 교실 인테리어
              </a>
        ...
        <div class="pt-4 border-t border-stone-100">
          ...
          <p class="text-xs text-stone-500 leading-relaxed">
            ※ 위 목록은 지니 인테리어의 실제 시공사례를 기준으로 구성되어 있습니다.
            사이트의 샘플 프로젝트는 디자인 예시용이며 실제 시공실적 목록과 구분합니다.
          </p>
  ...
  return `
    <header class="bg-stone-900 text-stone-100 p-4 border-b border-stone-800">
      ...
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        ...
        >
          ${SITE_CONFIG.brand.nameKo} (${SITE_CONFIG.brand.nameEn})
        </a>
    ...
    <main class="max-w-7xl mx-auto px-4 py-12 space-y-8">
      ...
      <section class="bg-white p-8 rounded-3xl border border-stone-200 shadow-sm space-y-4">
        ...
        <h2 class="text-xl font-bold text-stone-900">
          ${SITE_CONFIG.brand.nameKo} 공식 정보 및 책임시공 가이드
        </h2>
...
`;
    ...
    // --------------------------------------------------
    // SEMANTIC HTML FOR SEARCH CRAWLERS
    // --------------------------------------------------
  ...
  console.log(
    "[Static Pre-render] Completed successfully!"
  );
}
